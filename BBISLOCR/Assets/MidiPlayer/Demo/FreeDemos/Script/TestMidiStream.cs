    ...
    public class TestMidiStream : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            if (midiStreamPlayer != null)
            {
                ...
                //GUILayout.Label(" ", myStyle.TitleLabel3, GUILayout.Width(50));
                Frequency = Slider("Frequency", Frequency, 0.05f, 10f,true,115);
                GUILayout.EndHorizontal();
                GUILayout.EndVertical();
                ...
                NoteDuration = Slider("Duration", NoteDuration, -1f, 100f);
